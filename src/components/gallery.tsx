        ...
        {images.map((imageUrl, index) => (
          <>
            <Transition
              ...
              src={imageUrl}
              alt={`Slide ${index}`}
              className={`w-3/4 left-1/2 rounded-lg hover:scale-105 -translate-x-1/2 z-10 aspect-video object-cover absolute top-1/2 -translate-y-1/2 lg:hidden transition-all duration-500 ${
            ...
            <img
              ...
              src={imageUrl}
              alt={`Slide ${index}`}
              className={`w-full z-0 aspect-video object-cover absolute top-0 hidden lg:block left-0 transition-all duration-500 ${
                index === currentSlide ? "opacity-100" : "opacity-0"
              }`}
            />
          </>
